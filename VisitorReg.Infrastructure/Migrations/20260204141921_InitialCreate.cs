        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisterNo = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    IdNumberMasked = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ...
                    UpdatedBy = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visitors_CheckInAt",
                table: "Visitors",
                column: "CheckInAt");

            migrationBuilder.CreateIndex(
                name: "IX_Visitors_CheckInAt_Status",
                table: "Visitors",
                columns: new[] { "CheckInAt", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Visitors_HostName_CheckInAt",
                table: "Visitors",
                columns: new[] { "HostName", "CheckInAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Visitors_RegisterNo",
                table: "Visitors",
                column: "RegisterNo",
                unique: true);
